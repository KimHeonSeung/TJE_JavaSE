...
public class Operator_06 {
	...
	public static void main(String[] args) {
		...
		// (일반적으로 변수에 값을 대입(초기화)할 때 사용)
		// 대입연산자는 우항의 값을 좌항에 대입한 후 우항의 값을 반환한다.
		// 대입하고 남는값은 왼쪽의 값만 남는다.
		...
		// 10 + 7의 결과를 num 변수에 대입
		num = 10 + 7;
		System.out.printf("num -> %d\n",
				num);
		
		// 대입연산자를 사용하여 다수개의 변수를 동일한 값으로 초기화를 할 수 있다.
		int n1, n2, n3;
		n1 = n2 = n3 = 33;
		...
		// 아래의 코드는 컴파일 된 이후 n5 = n5 + 10; 과 같이 동작한다.
		n5 += 10; // n5 = n5 + 10;
		System.out.printf("n5 -> %d\n", n5 );
